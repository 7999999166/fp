...
<div class="app">
  <nav class="navbar navbar-dark navbar-expand-md bg-dark py-3 w3-top">
    <div class="container"><a class="navbar-brand d-flex align-items-center" href="#"><span>Akhil Stainless Steel Pvt Ltd</span></a><button class="navbar-toggler" data-bs-toggle="collapse" data-bs-target="#navcol-6"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
  ...
  <footer class="text-center bg-dark ">
    <div class="container text-white py-4 py-lg-5">
        <ul class="list-inline">
            <li class="list-inline-item me-4"><a class="link-light jiji" href="/termsCondition">Terms & Conditions</a></li>
            <li class="list-inline-item me-4"><a class="link-light jiji" href="/privacyPolicy">Privacy Policy</a></li>
            <li class="list-inline-item"><a class="link-light jiji" href="/returnRefund">Refund & Return</a></li>
        </ul>
        <ul class="list-inline">
